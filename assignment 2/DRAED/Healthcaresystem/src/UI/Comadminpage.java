 ...
 * @author Pritika
 */
public class Comadminpage extends javax.swing.JFrame {

    /**
     * Creates new form Comadminpage
     */
    Communitydetailslist dict;
    
    public Comadminpage(Communitydetailslist dict) {
        initComponents();
        this.dict=dict;
    }
    ...
    private void btnaddpeopleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaddpeopleActionPerformed
       ...
       Comadminadd comadminadd = new Comadminadd (dict);
       jSplitPane1.setRightComponent(comadminadd);
    ...
    private void btnviewpeopleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnviewpeopleActionPerformed
        // TODO add your handling code here:
        Communityview communityview = new Communityview (dict);
       jSplitPane1.setRightComponent(communityview);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Comadminpage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
//                new Comadminpage().setVisible(true);
            }
        });
    }
